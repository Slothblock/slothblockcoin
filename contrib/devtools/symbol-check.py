...
# binaries for release. These are static for each major version of SlothBlockCoin Core.
#
...
'CXXABI':  (1,3,3),
'GLIBCXX': (3,4,13),
'V':         (0,5,0),  # xkb (slothblockcoin-qt only)
}
...
# slothblockcoind and slothblockcoin-qt
