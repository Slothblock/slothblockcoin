# Building slothblockcoin-qt 1.14 on MacOS #

Tested on MacOs Ventura and Sonoma on Intel (x86_64) and Apple Silicon (arm64) macs.

### Clone slothblockcoin locally, or check it out, etc. ###
...
### Go back to your SlothBlockCoin repo ###
...
```sh
/usr/local/bin/slothblockcoin-qt
```
