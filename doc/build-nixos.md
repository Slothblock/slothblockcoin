...
Clone and enter the repo:
    ...
    $ git clone https://github.com/slothblockcoin/slothblockcoin
    $ cd slothblockcoin

Enter the `nix-shell` environment with all the SlothBlockCoin dependencies present:
