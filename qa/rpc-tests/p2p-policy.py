#!/usr/bin/env python3
# Copyright (c) 2021-2022 The SlothBlockCoin Core developers
...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # a SlothBlockCoin Core node that behaves similar to mainnet policies
    ...
    def run_test(self):
        ...
        ### test constants ###
        koinu = Decimal("0.00000001")          # 1 Koinu expressed in SLBC
        ten = Decimal("10.0")                  # uniform 10 SLBC seed moneys
        ...
        # create a bunch of UTXO with seed money from the SlothBlockCoin Core wallet
        for i in range(20):
        ...
        # test legacy output of 1 SLBC output and 1 SLBC fee
    ...
    # spend seed money with a key not in the SlothBlockCoin Core wallet.
    def spend_utxo(self, output, expected_size, retries=0):
        # construct the transaction using SlothBlockCoin Core raw tx APIs
        ...
        # and send the tx from there rather than from SlothBlockCoin Core, to test
