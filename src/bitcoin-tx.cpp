...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s slothblockcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  slothblockcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded slothblockcoin transaction") + "\n" +
              "  slothblockcoin-tx [options] -create [commands]   " + _("Create hex-encoded slothblockcoin transaction") + "\n" +
              "\n";
