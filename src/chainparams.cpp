...
// Copyright (c) 2024 The SlothBlockCoin Core developers
...
{
    const char* pszTimestamp = "Wall Street Journal 15/Oct/2023 – 'A Recession Is No Longer the Consensus', SlothBlockCoin embraces 'Be Kind Everyday'.";
    const CScript genesisOutputScript = CScript() << ParseHex("0375e27e134db7c27c8e7541d78152a6ee10700843520e8815a87542e4a88e651e") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nSubsidyReductionInterval = 525960;
        ...
        // XXX: BIP heights and hashes all need to be updated to SlothBlockCoin values
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1714340525; // Apr 28th, 2024
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout =  	1745876525; // Apr 28th, 2025

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1714340525; // November 15th, 2016.
        ...
        // vSeeds.push_back(CDNSSeedData("10.0.0.4", "10.0.0.4", true));
        vSeeds.push_back(CDNSSeedData("seed0.slothblock.info", "seed0.slothblock.info"));
        vSeeds.push_back(CDNSSeedData("vps0.slothblock.info", "vps0.slothblock.info"));
        vSeeds.push_back(CDNSSeedData("seed1.slothblock.info", "seed1.slothblock.info"));
        vSeeds.push_back(CDNSSeedData("vps1.slothblock.info", "vps1.slothblock.info"));
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,63); // S
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,22);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,158);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x02)(0xfa)(0x79)(0xab).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x02)(0xfa)(0x79)(0xbc).convert_to_container<std::vector<unsigned char> >();

        vFixedSeeds = std::vector<SeedSpec6>(pnSeed6_main, pnSeed6_main + ARRAYLEN(pnSeed6_main));

        fMiningRequiresPeers = false; //set to false until chain grows
        ...
        checkpointData = (CCheckpointData) {
            ...
            //( 5259600, uint256S("0x6aae55bea74235f0c80bd066349d4440c31f2d0f27d54265ecd484d8c1d11b47"))
        ...
        chainTxData = ChainTxData{
            ...
            1714340525, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1714340525; // Apr 28th, 2024
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 0; // Disabled
        ...
        // looking for seeders for testnet/contact info@slothblock.com
        ...
        checkpointData = (CCheckpointData) {
            ...
            // ( 5259600, uint256S("0x1fe4d44ea4d1edb031f52f0d7c635db8190dc871a190654c41d2450086b8ef0e"))
...
public:
    CRegTestParams() {
        ...
        consensus.nSubsidyReductionInterval = 150;
        ...
        consensus.BIP34Hash = uint256S("0x230da5f94baf6a308c6f4f7823fb2f667ca9a7571eddb1706a2972bba8bebbcf");
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x230da5f94baf6a308c6f4f7823fb2f667ca9a7571eddb1706a2972bba8bebbcf");
        ...
        genesis = CreateGenesisBlock(1714340525, 0, 0x207fffff, 1, 20000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        assert(consensus.hashGenesisBlock == uint256S("0x230da5f94baf6a308c6f4f7823fb2f667ca9a7571eddb1706a2972bba8bebbcf"));
        assert(genesis.hashMerkleRoot == uint256S("0x45f0583b2f8cf02ad2264b9dba3e3c14758878904c0516a677939841883fe9a3"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x230da5f94baf6a308c6f4f7823fb2f667ca9a7571eddb1706a2972bba8bebbcf"))
        };
