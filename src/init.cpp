...
void Shutdown()
{
    ...
    RenameThread("slothblockcoin-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // SlothBlockCoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/slothblockcoin/slothblockcoin>";
    const std::string URL_WEBSITE = "<https://slothblockcoin.com>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("slothblockcoin-loadblk");
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("SlothBlockCoin version %s\n", FormatFullVersion());
}
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // SlothBlockCoin: Do we need to do any RPC mining init here?
