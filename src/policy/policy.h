...
/** Recommended transaction fee by SlothBlockCoin Core developers
  *
 ...
 *
 *  SlothBlockCoin:    Increment mempool limits and accept RBF in steps of 0.0001 SLBC
...
/**
 * SlothBlockCoin: Default dust limit that is evaluated when considering whether a
...
/**
 * SlothBlockCoin: Default hard dust limit that is evaluated when considering whether
