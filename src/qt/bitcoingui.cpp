...
// Copyright (c) 2021-2023 The SlothBlockCoin Core developers
    ...
    platformStyle(_platformStyle)
{
    ...
    // SlothBlockCoin: load fallback font in case Comic Sans is not available on the system
    ...
    // SlothBlockCoin: load this bundled font for Settings -> Options in case it's not available on the system
    ...
    // SlothBlockCoin: Specify NotoSans as new font.
    QFont newFont("NotoSans", 10);

    // SlothBlockCoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SlothBlockCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and slothblockcoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SlothBlockCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SlothBlockCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a slothblockcoin: URI or payment request"));

    importPrivateKeyAction = new QAction(platformStyle->TextColorIcon(":/icons/address-book"), tr("&Import Private Key..."), this);
    importPrivateKeyAction->setStatusTip(tr("Import a SlothBlockCoin private key"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible SlothBlockCoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    backupWalletAction->setEnabled(false);
    ...
    paperWalletAction->setEnabled(false); // disable paper wallets until we have assets for background image...
}
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to SlothBlockCoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("SlothBlockCoin"); // default title
