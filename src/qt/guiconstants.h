...
#define QAPP_ORG_NAME "SlothBlockCoin"
#define QAPP_ORG_DOMAIN "slothblockcoin.org"
#define QAPP_APP_NAME_DEFAULT "SlothBlockCoin-Qt"
#define QAPP_APP_NAME_TESTNET "SlothBlockCoin-Qt-testnet"
