...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the SlothBlockCoin Core repository on GitHub"),
        tr("Services that claim to double your slothblockcoins are always ponzi schemes")
    };
