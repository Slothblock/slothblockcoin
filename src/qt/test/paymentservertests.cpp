...
// Copyright (c) 2020-2023 The SlothBlockCoin Core developers
...
void PaymentServerTests::paymentServerTests()
{
    ...
    // SlothBlockCoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for SlothBlockCoin (as there is no actual maximum coins)
