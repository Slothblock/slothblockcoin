...
#ifndef SLOTHBLOCKCOIN_SUPPORT_EXPERIMENTAL_H
#define SLOTHBLOCKCOIN_SUPPORT_EXPERIMENTAL_H
...
#if defined(ALLOW_SLOTHBLOCKCOIN_EXPERIMENTAL)
#define EXPERIMENTAL_FEATURES_ALLOWED 1
#else
#define EXPERIMENTAL_FEATURES_ALLOWED 0
#endif // ALLOW_SLOTHBLOCKCOIN_EXPERIMENTAL
